...
class HashMap:
    ...
    def put(self, key: str, value: object) -> None:  # <------------------------ Done
        """
        ...
        for i in range(self._capacity):
            probe_index = (hash_index + i**2) % self._capacity
    ...
    def empty_buckets(self) -> int:
        ...
        count = 0
        for i in range(self._capacity):
            if not self._buckets[i] or self._buckets[i].is_tombstone:
                count += 1
        return count

    def resize_table(self, new_capacity: int) -> None:
        """
        Changes capacity of hash table as indicated by input int.
        """
    ...
    def get(self, key: str) -> object:
        """
        Returns the value associated with the given key. Returns None if not
        in the map.
        """
        hash_index = self._hash_function(key) % self._capacity
    ...
    def contains_key(self, key: str) -> bool:
        """
        Returns True if key is within the hash map.
        """
        hash_index = self._hash_function(key) % self._capacity
    ...
    def __next__(self):
        while self._iter_index < self._buckets.length():
            current_entry = self._buckets[self._iter_index]
            self._iter_index += 1
